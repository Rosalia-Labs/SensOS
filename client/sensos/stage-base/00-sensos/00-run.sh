...
install -m 644 files/docker/docker-compose.yml "${SHARE_DIR}/docker-compose.yml"
cp -r files/docker/birdnet "${SHARE_DIR}"
cp -r files/docker/database "${SHARE_DIR}"
cp -r files/docker/sound_capture "${SHARE_DIR}"
