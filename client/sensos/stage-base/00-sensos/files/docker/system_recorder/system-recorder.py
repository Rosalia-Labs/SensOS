...
INTERVAL = int(os.environ.get("RECORD_INTERVAL_SEC", 300))  # default: 5 minutes
HOST_ROOT = os.environ.get("HOST_ROOT", "/host")  # root of host-mounts
...
def get_sensor_stats():
    # Placeholder: Replace with actual data sources later
    return {
